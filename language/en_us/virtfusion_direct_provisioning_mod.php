...
$lang['VirtfusionDirectProvisioningMod.storage.disk_mismatch'] = 'Service storage is %1$s GB; VirtFusion disk is %2$s GB. Manual disk adjustment is required.';
...
$lang['VirtfusionDirectProvisioningMod.!error.rebuild.name'] = 'Enter a server name of 255 characters or fewer.';
$lang['VirtfusionDirectProvisioningMod.!error.rebuild.hostname'] = 'If provided, enter a valid fully qualified hostname, such as server.example.com.';
$lang['VirtfusionDirectProvisioningMod.!error.rebuild.ssh_keys'] = 'One or more selected SSH keys are not available to this server owner.';
$lang['VirtfusionDirectProvisioningMod.!error.rebuild.ssh_key_required'] = 'Select or import an SSH key, or choose password login.';
...
$lang['VirtfusionDirectProvisioningMod.!error.server.unavailable'] = 'VirtFusion server state is currently unavailable. Refresh the page and try again.';
...
$lang['VirtfusionDirectProvisioningMod.service_info.resources_current'] = 'Current Resources';
$lang['VirtfusionDirectProvisioningMod.service_info.traffic'] = 'Traffic';
$lang['VirtfusionDirectProvisioningMod.service_info.traffic_bandwidth'] = 'Traffic and Bandwidth';
...
$lang['VirtfusionDirectProvisioningMod.service_info.usage'] = 'Usage';
$lang['VirtfusionDirectProvisioningMod.service_info.latest_backup'] = 'Latest Backup';
$lang['VirtfusionDirectProvisioningMod.service_info.traffic_resets'] = 'Next Reset';
$lang['VirtfusionDirectProvisioningMod.service_info.traffic_used'] = 'Traffic Used';
$lang['VirtfusionDirectProvisioningMod.service_info.traffic_in'] = 'Inbound';
$lang['VirtfusionDirectProvisioningMod.service_info.traffic_out'] = 'Outbound';
$lang['VirtfusionDirectProvisioningMod.service_info.traffic_sum'] = 'Total';
...
$lang['VirtfusionDirectProvisioningMod.service_info.unlimited'] = 'Unlimited';
$lang['VirtfusionDirectProvisioningMod.service_info.network'] = 'Network';
...
$lang['VirtfusionDirectProvisioningMod.tabManage.operating_system'] = 'Operating System';
$lang['VirtfusionDirectProvisioningMod.tabManage.more_features'] = 'More Features';
$lang['VirtfusionDirectProvisioningMod.tabManage.open_virtfusion'] = 'Open VirtFusion Control Panel';
...
$lang['VirtfusionDirectProvisioningMod.tabManage.reinstall'] = 'Reinstall Operating System';
$lang['VirtfusionDirectProvisioningMod.tabManage.install'] = 'Install Operating System';
$lang['VirtfusionDirectProvisioningMod.tabManage.os_family'] = 'Operating System';
$lang['VirtfusionDirectProvisioningMod.tabManage.os_template'] = 'Version';
$lang['VirtfusionDirectProvisioningMod.tabManage.select_os_family'] = 'Select an operating system';
$lang['VirtfusionDirectProvisioningMod.tabManage.select_os_template'] = 'Select a version';
$lang['VirtfusionDirectProvisioningMod.tabManage.select_os_first'] = 'Select an operating system first';
$lang['VirtfusionDirectProvisioningMod.tabManage.os_selection_empty'] = 'No operating system selected.';
$lang['VirtfusionDirectProvisioningMod.tabManage.os_version_required'] = 'Select a version to continue.';
$lang['VirtfusionDirectProvisioningMod.tabManage.server_name'] = 'Server Name';
$lang['VirtfusionDirectProvisioningMod.tabManage.hostname'] = 'Hostname (optional)';
$lang['VirtfusionDirectProvisioningMod.tabManage.network_settings'] = 'Network Settings';
$lang['VirtfusionDirectProvisioningMod.tabManage.authentication'] = 'Login Method';
$lang['VirtfusionDirectProvisioningMod.tabManage.ssh_keys'] = 'SSH Keys';
$lang['VirtfusionDirectProvisioningMod.tabManage.ssh_key_choice'] = 'Select one or more saved keys, or import a new public key.';
$lang['VirtfusionDirectProvisioningMod.tabManage.ssh_key_login'] = 'SSH key login';
$lang['VirtfusionDirectProvisioningMod.tabManage.ssh_key_login_help'] = 'Recommended. Choose a saved key or import a public key.';
$lang['VirtfusionDirectProvisioningMod.tabManage.ssh_keys_none'] = 'No saved SSH keys are available. Import a public key to continue.';
$lang['VirtfusionDirectProvisioningMod.tabManage.password_login_title'] = 'Password login';
$lang['VirtfusionDirectProvisioningMod.tabManage.password_login'] = 'I will use password login';
$lang['VirtfusionDirectProvisioningMod.tabManage.password_login_warning'] = 'Password login is less secure. A new password will be generated automatically.';
$lang['VirtfusionDirectProvisioningMod.tabManage.password_login_notice'] = 'A password will be generated automatically. Password login is less secure, so store the generated password somewhere safe when it is shown.';
$lang['VirtfusionDirectProvisioningMod.tabManage.import_ssh_key'] = 'Import a new SSH key';
$lang['VirtfusionDirectProvisioningMod.tabManage.ssh_key_name'] = 'SSH Key Name';
$lang['VirtfusionDirectProvisioningMod.tabManage.ssh_public_key'] = 'OpenSSH Public Key';
$lang['VirtfusionDirectProvisioningMod.tabManage.install_button'] = 'Install';
...
$lang['VirtfusionDirectProvisioningMod.password_result.notice'] = 'VirtFusion confirmed that the password reset completed. Store the new password now; it may not be displayed again.';
$lang['VirtfusionDirectProvisioningMod.password_result.pending_heading'] = 'Password Reset In Progress';
$lang['VirtfusionDirectProvisioningMod.password_result.pending_notice'] = 'VirtFusion generated the expected password below, but the reset job has not finished yet. The password may not work until the job completes and the server restarts.';
$lang['VirtfusionDirectProvisioningMod.password_result.failed_heading'] = 'Password Reset Failed';
$lang['VirtfusionDirectProvisioningMod.password_result.failed_notice'] = 'VirtFusion reported that the password reset job failed. The expected password below may not have been applied. Retry the reset or contact support.';
$lang['VirtfusionDirectProvisioningMod.password_result.unknown_heading'] = 'Password Reset Status Unavailable';
$lang['VirtfusionDirectProvisioningMod.password_result.unknown_notice'] = 'The expected password is shown below, but VirtFusion did not provide a status that could be confirmed. The password may not have been applied.';
$lang['VirtfusionDirectProvisioningMod.password_result.password'] = 'Expected Password';
$lang['VirtfusionDirectProvisioningMod.password_result.checking'] = 'Checking reset status';
$lang['VirtfusionDirectProvisioningMod.action_working.reset_password'] = 'Resetting Password';
$lang['VirtfusionDirectProvisioningMod.action_working.install'] = 'Starting Installation';
$lang['VirtfusionDirectProvisioningMod.action_working.reinstall'] = 'Starting Reinstall';
$lang['VirtfusionDirectProvisioningMod.action_working.wait'] = 'Sending the request to VirtFusion. Please wait.';
$lang['VirtfusionDirectProvisioningMod.action_working.unconfirmed'] = 'The VirtFusion request status could not be confirmed. Refresh the server state before retrying.';
$lang['VirtfusionDirectProvisioningMod.action_result.close'] = 'Close';
...
$lang['VirtfusionDirectProvisioningMod.password_result.saved'] = 'I have saved this password';
$lang['VirtfusionDirectProvisioningMod.build_password_result.heading'] = 'Installation Password';
$lang['VirtfusionDirectProvisioningMod.build_password_result.notice'] = 'The new root password is shown once below. Store it before leaving or refreshing this page.';
$lang['VirtfusionDirectProvisioningMod.build_progress.reinstalling'] = 'Reinstalling operating system';
$lang['VirtfusionDirectProvisioningMod.build_progress.installing'] = 'Installing operating system';
$lang['VirtfusionDirectProvisioningMod.build_progress.ssh_wait'] = 'You selected SSH key authentication. Please wait while VirtFusion installs this server.';
$lang['VirtfusionDirectProvisioningMod.build_progress.ssh_reinstall_wait'] = 'You selected SSH key authentication. Please wait while VirtFusion reinstalls this server.';
$lang['VirtfusionDirectProvisioningMod.build_progress.password_wait'] = 'Password login was selected. Save the generated password below while VirtFusion installs this server.';
$lang['VirtfusionDirectProvisioningMod.build_progress.password_reinstall_wait'] = 'Password login was selected. Save the generated password below while VirtFusion reinstalls this server.';
$lang['VirtfusionDirectProvisioningMod.build_progress.password'] = 'Your password is:';
$lang['VirtfusionDirectProvisioningMod.build_progress.checking'] = 'Checking installation status';
$lang['VirtfusionDirectProvisioningMod.build_progress.complete'] = 'Installation complete';
$lang['VirtfusionDirectProvisioningMod.build_progress.reinstall_complete'] = 'Reinstallation complete';
$lang['VirtfusionDirectProvisioningMod.build_progress.complete_hint'] = 'VirtFusion has finished installing this server.';
$lang['VirtfusionDirectProvisioningMod.build_progress.refresh'] = 'Refresh server details';
...
$lang['VirtfusionDirectProvisioningMod.vnc.reconnecting'] = 'Connection lost. Reconnecting in 3 seconds...';
...
$lang['VirtfusionDirectProvisioningMod.vnc.keyboard'] = 'Keyboard';
...
$lang['VirtfusionDirectProvisioningMod.vnc.quality'] = 'Quality';
$lang['VirtfusionDirectProvisioningMod.vnc.quality_fast'] = 'Fast';
$lang['VirtfusionDirectProvisioningMod.vnc.quality_balanced'] = 'Balanced';
$lang['VirtfusionDirectProvisioningMod.vnc.quality_best'] = 'Best';
$lang['VirtfusionDirectProvisioningMod.vnc.screenshot'] = 'Screenshot';
$lang['VirtfusionDirectProvisioningMod.vnc.screenshot_saved'] = 'Screenshot saved.';
$lang['VirtfusionDirectProvisioningMod.vnc.screenshot_failed'] = 'The screenshot could not be created.';
$lang['VirtfusionDirectProvisioningMod.vnc.clipboard'] = 'Clipboard';
$lang['VirtfusionDirectProvisioningMod.vnc.clipboard_placeholder'] = 'Enter text to place on the remote clipboard or type into the active remote window.';
$lang['VirtfusionDirectProvisioningMod.vnc.clipboard_help'] = 'Send Clipboard requires guest clipboard support. Send as Keys works at login screens and terminals.';
$lang['VirtfusionDirectProvisioningMod.vnc.send_clipboard'] = 'Send Clipboard';
$lang['VirtfusionDirectProvisioningMod.vnc.send_keys'] = 'Send as Keys';
$lang['VirtfusionDirectProvisioningMod.vnc.send_keys_empty'] = 'Enter text before sending keys.';
$lang['VirtfusionDirectProvisioningMod.vnc.send_keys_typing'] = 'Typing text into the remote window...';
$lang['VirtfusionDirectProvisioningMod.vnc.send_keys_sent'] = 'Text sent as keystrokes.';
...
$lang['VirtfusionDirectProvisioningMod.confirm.reset_password'] = 'Resetting the password will restart this server. Existing SSH configuration may not be updated. The new password will be displayed once on this page and may also be emailed. Continue?';
$lang['VirtfusionDirectProvisioningMod.confirm.reinstall'] = 'Reinstalling permanently erases all data on this server. Are you sure you want to continue?';
$lang['VirtfusionDirectProvisioningMod.confirm.heading'] = 'Confirm Action';
$lang['VirtfusionDirectProvisioningMod.confirm.cancel'] = 'Cancel';
$lang['VirtfusionDirectProvisioningMod.confirm.continue'] = 'Continue';
...
$lang['VirtfusionDirectProvisioningMod.ipAddresses.ipv4'] = 'IPv4 Addresses';
$lang['VirtfusionDirectProvisioningMod.ipAddresses.ipv6_blocks'] = 'IPv6 Blocks';
$lang['VirtfusionDirectProvisioningMod.ipAddresses.ipv6_available'] = 'IPv6 is available for this service but is not enabled on this server.';
$lang['VirtfusionDirectProvisioningMod.ipAddresses.enable_ipv6'] = 'Enable IPv6';
$lang['VirtfusionDirectProvisioningMod.ipAddresses.ipv6_choice_heading'] = 'Set Up IPv6';
$lang['VirtfusionDirectProvisioningMod.ipAddresses.ipv6_choice_help'] = 'Choose where you want to continue setting up IPv6.';
$lang['VirtfusionDirectProvisioningMod.ipAddresses.open_virtfusion'] = 'Open VirtFusion';
$lang['VirtfusionDirectProvisioningMod.ipAddresses.reinstall_enable'] = 'Reinstall and Enable';
