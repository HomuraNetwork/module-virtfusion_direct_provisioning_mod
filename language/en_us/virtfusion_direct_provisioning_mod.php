...
$lang['VirtfusionDirectProvisioningMod.storage.ticket_required'] = 'The billed storage exceeds the disk currently provisioned on this server. VirtFusion only expands the primary disk through a package change, so open a support ticket to have the additional space applied.';
